...
public class PlantVisualiser : MonoBehaviour
{
    ...
    void DrawTree(bool isDrawingFullTree=true)
    {
        int counter = 0;
        ...
        for (int i = 0; i < preloadedInstructions.Length; i++)
        {
            ...
            switch (preloadedInstructions[i])
            {
                case 'F':
                    ...
                    {
                        treeSegment = generatedTree.transform.GetChild(counter).gameObject;
                        counter++;
                    }
                ...
                case ']':
                    ...
                    if (HasLeaves)
                    {
                        ...
                        int scale = isDrawingFullTree ? BranchLengthScalar : 1;
